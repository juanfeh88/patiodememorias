...
<div className="relative z-10 flex flex-col justify-center items-start px-8 md:px-20 pt-24 md:pt-32 w-full max-w-4xl text-left text-animate min-h-screen">
